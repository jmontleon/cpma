...
// Keystone contains the keystone provider information
...
// CA Contains keystone CA Name
type CA struct {
	Name string `yaml:"name"`
}

// TLSClientCert Contains TLS Client Cert Name
type TLSClientCert struct {
	Name string `yaml:"name"`
}

// TLSCLientKey Contains TLS CLient Key Name
